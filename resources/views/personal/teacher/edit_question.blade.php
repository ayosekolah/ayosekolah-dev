...
<title>Edit Question by Clas| {{env('APP_NAME','Ayo Sekolah') }}</title>
...
<div class="col-sm-12 col-lg-12">
    <div class="row">
        <div class="col-lg-12 mb-4">
            ...
            <a href="{{url('personal/teacher/quiz/class/edit',$quiz->id)}}" class="btn btn-secondary"><i class="fas fa-arrow-left "></i> Quizzes Editor</a>
        </div>
        <div class="col-md-8">
            <div class="card mb-3 rounded shadow-sm">
                ...
                <div class=" card-body">
                        <form action="{{route('personal.teacher.clas.question.update',['quiz_id' => $quiz->id, 'question_id' => $question->id])}}" method="POST" enctype="multipart/form-data" id="form_edit">
                            @csrf
                            @method('PUT')
