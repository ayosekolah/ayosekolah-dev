...
<html lang="en">
  <head>
    ...
    <title>Login for Business | Ayo Sekolah</title>
    <!-- vendor css -->
  ...
  <body>
    ...
    <div class="content content-fixed content-auth bg-info">
      <div class="container">
        <div class="media align-items-stretch justify-content-center ht-100p">
          <div class="sign-wrapper mg-lg-r-50 mg-xl-r-60">
            <div class="pd-t-20 wd-100p">
              <h4 class="tx-white mg-b-5">Login <b>Sekolah / Instansi</b></h4>
              <p class="tx-white tx-16 mg-b-40">Selamat Datang! Silahkan login Untuk memulai.</p>
              @include('_partial.alert')
              <form action="{{ route('business.login.proccess') }}" method="POST" data-parsley-validate>
                @csrf
              ...
              <div class="tx-white mg-t-20 tx-center">Don't have an account? <a href="{{ route('business.register') }}">Create Account</a></div>
            </div>
          </div><!-- sign-wrapper -->
          <div class="media-body pd-y-30 pd-lg-x-50 pd-xl-x-60 align-items-center d-none d-lg-flex pos-relative">
            <div class="mx-lg-wd-500 mx-xl-wd-550">
              <img src="{!! asset('v1/images/web/ayosekolah2.png') !!}" class="img-fluid" alt="">
            </div>
          </div><!-- media-body -->
        </div><!-- media -->
      </div><!-- container -->
