@extends('business.layout')
    @section('header')
        ...
        <title>Edit and Approve | Ayo Sekolah</title>
    @endsection
    @section('contents')
                        ...
                        <form action="{{ url('business/clas_personal/is_aprroved/'.$personal->id) }}?redirect_url={{$redirect}}" method="POST" data-parsley-validate>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="custom-control custom-switch">
                                            ...
                                            <label class="custom-control-label" for="customSwitch3">{{ $personal->personalBusines[0]->is_approve == 1  ? 'Approved' :'Not Approve' }}</label>
                                    </div>
                            </div>
