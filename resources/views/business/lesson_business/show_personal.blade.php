@extends('business.layout')
    ...
    <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
            <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
                <div>
                <h4 class="mg-b-0 tx-spacing--1">All Personal In Lesson</h4>
                </div>
                <div class="d-none d-md-block">
                        <a class="btn btn-sm  btn-info btn-uppercase mg-l-5 text-white" href="{{ route('business.lesson_business.index') }}">
                            <i class="fa fa-angle-left"></i> Back To Lesson
                        </a>
                </div>
            </div>
