@extends('business.layout')
    @section('header')
        ...
        <title>All Classes | Ayo Sekolah</title>
    @endsection
    @section('contents')
    <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
            <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
                ...
                <div class="d-none d-md-block">
                        <a class="btn btn-sm  btn-primary btn-uppercase mg-l-5 text-white" href="{{ route('business.clas.create') }}">
    ...
    <script>
        $('#data').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ url('business/clas/get_data') }}",
                columns: [
                            { data: 'name', name: 'name' },
