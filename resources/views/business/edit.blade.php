        ...
        <div class="row row-xs">
            ...
            <div class="col-sm-12 col-lg-12 mb-4">
                <div class="card card-body h-100  shadow-sm">
                    <form  method="POST" action="{{ route('business.update') }}" class="row" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="col-md-7">
                            <fieldset class="form-fieldset">
                                    <legend>business Information</legend>
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="username" value="{{ $business->username }}" class="form-control" placeholder="Enter your username">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" minlength="10"  name="phone" value="{{ $business->phone }}" class="form-control"  placeholder="Enter your Phone Number">
                                            @if ($errors->has('phone'))
                                            <ul class="parsley-errors-list filled" id="parsley-id-5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" minlength="1"  name="fax" value="{{ $business->fax }}" placeholder="Enter your Fax Number" class="form-control">
                                            @if ($errors->has('fax'))
                                            <ul class="parsley-errors-list filled" id="parsley-id-5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="address"  cols="30" rows="5" class="form-control" placeholder="Enter your Address">{{$business->address}}</textarea>
                                                ...
                                                <div class="col-md-4">
                                                        ...
                                                        <div class="image-upload">
                                                                <label for="profile-img">
                                                                    <img  id="profile-img-tag" src="{{ getImg($business->image) }}" width="500px" class="img-thumbnail"/>
                        ...
                        <div class="col-md-5">
                                ...
                                <div class="text-right">
                                    <a href="{{ url('business/dashboard')}}" class="btn btn-light text-black">Back</a>
