...
<html lang="en">
  <head>
    ...
    <title>Register for Business | Ayo Sekolah</title>
  ...
  <body>
    <header class="navbar navbar-header navbar-header-fixed">
      ...
      <div class="navbar-brand">
          <a href="#" class="df-logo d-lg-inline-block d-none">
    ...
    <div class="content content-fixed content-auth" style="background-color:#00944F">
      <div class="container">
        <div class="media align-items-stretch justify-content-center ht-100p">
          <div class="sign-wrapper mg-lg-r-50 mg-xl-r-60">
            <div class="pd-t-20 wd-100p">
              <h4 class="tx-white mg-b-5">Buat Akun <b>Sekolah/Instansi</b> Baru!</h4>
              <p class="tx-white tx-16 mg-b-40">Gratis Daftar dengan Sangat Mudah.</p>
              <form action="{{ route('bussines.register.proccess') }}" method="POST" data-parsley-validate>
                @csrf
                <div class="tx-white form-group">
                    <label>Nama</label>
                    <input type="text" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}"  value="{{ old('name') }}" placeholder="Enter your Business" name="name" required>
                    @if ($errors->has('name'))
                ...
                <div class="tx-white form-group tx-12">
                    Dengan Klik <strong>Daftar</strong> dibawah ini, Anda telah menyetujui terms of service dan privacy statement kami.
                </div>
                <button class="btn btn-brand-02 btn-block">Daftar</button>
            </form>
              <div class="tx-white divider-text">atau</div>
              <div class="tx-13 mg-t-20 tx-center tx-white">Sudah Punya Akun? <a class="tx-white" href="{{ route('business.login') }}"><b>Sign In</b></a></div>
            </div>
          </div><!-- sign-wrapper -->
          <div class="media-body pd-y-30 pd-lg-x-50 pd-xl-x-60 align-items-center d-none d-lg-flex pos-relative">
            <div class="mx-lg-wd-500 mx-xl-wd-550">
              <img src="{!! asset('v1/images/web/ayosekolah3.png') !!}" class="img-fluid" alt="">
            </div>
