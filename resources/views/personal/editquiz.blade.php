...
<title>Edit Quiz | Ayo Sekolah</title>
                    ...
                    <div class="card mb-3 rounded shadow-sm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                        ...
                                        <a href="{{route('personal.my_quiz.general.question.edit',['quiz_id' => $quiz->id, 'question_id' => $item->id])}}" class="p-2  bg-pink  text-white rounded-5">Edit</a>
                                        <a href="{{ url('personal/my_quiz/genetal/question/delete/'.$item->id) }}" class="p-2  flex-1 bg-orange text-white rounded-5">Delete</a>
                                        </div>
                                </div>
                            </div>
                            </div>
                ...
                <div class="modal fade bd-example-modal-lg" id="exampleModal">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ url('personal/my_quiz/general/question/create/'.$quiz->id) }}" method="POST" enctype="multipart/form-data" id="form_create">
                                @csrf
...
//         if(value != ""){
//             // console.log(value);
//             $(this).closest('.div_answer').closest('.image_upload').slideUp('fast');
//         }
//     });
// }
